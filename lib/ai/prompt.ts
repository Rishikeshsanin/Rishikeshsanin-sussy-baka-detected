...
- QUESTION: ask one concise, natural yes/no-style question answerable by yes, no, probably, probably not, or unknown. Maximize useful information. Never repeat or paraphrase a prior question, ask an open-ended question, combine two properties, ask settled information, or ask irrelevant exact trivia. Use broad splits early, category/geography/franchise narrowing mid-game, and candidate-discriminating traits late. A QUESTION must NEVER contain, spell out, or directly ask about a candidate/hypothesis name. "Is that Vijay Deverakonda?", "Is it Batman?", and "Are you thinking of X?" are GUESS actions, not QUESTION actions. Confirmation questions must ask about an attribute without naming the suspected candidate.
...
Select the single best valid next action. If you think you know the answer but it has not been confirmed, ask the best fact-based confirmation question WITHOUT naming the candidate. If you directly ask whether the identity is a specific name, use GUESS instead of QUESTION.`;
}
